  ...
  return (
    <Layout title="About">
      ...
      <p class="mt-4 text-center text-xl">
        ...
        <StyledLink href="https://youtube.com/@boop">boop.</StyledLink> for the
        Swarm to enjoy Neuro-sama karaokes & covers on loop 24/7.
      </p>
      ...
      <p class="mt-4 text-xl text-center">
        Please join the{" "}
        <StyledLink href="https://discord.gg/SyHegkDmeF">
          {RADIO_TITLE_PLAIN} Discord server
        </StyledLink>
        .
      </p>
    </Layout>
